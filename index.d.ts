...
interface Mul {
	...
	*
	* var out = mul.assign( 1, 2, 3, 4, new Uint32Array( 2 ), 1, 0 );
	* // returns <Uint32Array>[ 10, 8 ]
	*/
	assign<T extends NumericArray | Collection<number>>( ah: number, al: number, bh: number, bl: number, out: T, stride: number, offset: number ): T;
	...
	*
	* var out = mul.strided( a, 1, 0, b, 1, 0, new Uint32Array( 2 ), 1, 0 );
	* // returns <Uint32Array>[ 10, 8 ]
	*/
